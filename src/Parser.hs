...
happyExpList = Happy_Data_Array.listArray (0,62) ([30816,12306,2364,16384,3,4,512,49920,147,0,0,0,0,15408,6153,1182,20236,2,208,30720,1,0,0,32768,0,64,40472,3076,591,10118,49921,147,0,0,0,3072,0,6150,1182,20236,2,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseTokens","Exps","Exp","let","const","if","then","while","throw","print","str","var","int","'='","'+'","'-'","'*'","'/'","'('","')'","%eof"]
        bit_start = st * 23
        bit_end = (st + 1) * 23
...
happyReduction_13 (HappyTerminal (TLit happy_var_1))
	 =  HappyAbsSyn5
		 (Str happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TThrow -> cont 11;
	TPrint -> cont 12;
	TLit happy_dollar_dollar -> cont 13;
